  ...
  const data = {
    navMain: [
      ...
      },
      {
        ...
        badge: "12",
        submenu: [
          { title: "Manage Reservations", url: "#", icon: <FaList className="w-4 h-4" /> },
          { title: "Calendar View", url: "#", icon: <FaCalendarAlt className="w-4 h-4" /> },
          { title: "Booking History", url: "#", icon: <FaChartLine className="w-4 h-4" /> },
        ],
      },
      {
        title: "Events",
        ...
        <div className="flex h-16 text-white bg-gradient-to-r from-primary to-accent gap-3 items-center justify-start px-4 rounded-lg mx-2 mt-2 shadow-lg">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs text-white/90 font-medium">Admin Panel</span>
            </div>
          </div>
        </div>
      </SidebarHeader>
